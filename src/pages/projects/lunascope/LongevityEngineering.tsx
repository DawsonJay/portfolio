...
const LongevityEngineering = () => {
  return (
    <Article>
      ...
      <TextBlock 
        text="I set a 20-30 year target that requires eliminating wear mechanisms. I chose crystal oscillator (no drift), stepper motor (no brushes), supercapacitor (100K cycles). I applied copper patina to protect the surface."
