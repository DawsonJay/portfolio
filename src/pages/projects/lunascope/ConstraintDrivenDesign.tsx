...
const ConstraintDrivenDesign = () => {
  return (
    <Article>
      ...
      <TextBlock 
        text="I worked with a $128 budget and 27.5mW power constraint that forced creative solutions. I chose NEMA 8 motor instead of unavailable PTX05. I used worm gear £14 vs commercial gearbox £50. These constraints shaped a better design."
      ...
      <TextBlock 
        text="This constraint-driven design approach demonstrates my ability to work within severe limitations and turn them into advantages. The $128 budget forced creative solutions that actually improved the design (simpler components, fewer failure points). The power constraint led to better thermal design. The sourcing strategy saved £20-30 while maintaining quality. This shows I can work with resource constraints common in professional development—budget limits, performance requirements, timeline pressures—and find solutions that are better than obvious approaches. The skill of turning constraints into design drivers is valuable in any engineering role where resources are limited."
