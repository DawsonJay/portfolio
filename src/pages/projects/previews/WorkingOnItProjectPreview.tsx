...
import WorkingOnItPreviewImage from "../../../assets/projectPreviews/working-on-it-preview-image.jpg";

export default function WorkingOnItProjectPreview() {
  return (
    <Preview
      title={"Working on It"}
      concisePreviewText={"I have more space than projects. I'm working on it."}
      longPreviewText={
      ...
      previewImage={WorkingOnItPreviewImage}
